<!-- ============================================================
  ...
  ------------------------------------------------------------
  本 README 分为两类区块：
  1. 手写区：关于我、技术栈等，随时直接编辑，不会被覆盖
  2. 自动区：夹在 AUTO:START:区块名 与 AUTO:END:区块名 两个
     标记之间，由 GitHub Actions 定时调用
     scripts/generate-readme.mjs 自动生成，请勿手改

  自动区包含：
    badges    数字徽章（仓库数 / Stars / Forks / 关注者）
    pinned    精选项目 —— 自动同步 GitHub 主页的「置顶仓库」
    repos     仓库表格（按 Stars 与最近活跃排序）
    activity  最近动态（提交 / PR / Issue / Release…）
  贪吃蛇动画 assets/snake*.svg 也由工作流自动重新生成
  注意：HTML 注释内不能嵌套注释括号，否则会提前终止并泄漏正文
============================================================ -->
...
[![Typing SVG](https://readme-typing-svg.demolab.com?lines=Independent+Developer;VRChat+%2F+VR+%E5%B7%A5%E5%85%B7%E9%93%BE;TTS+%E8%AF%AD%E9%9F%B3%E5%90%88%E6%88%90;%E5%89%8D%E7%AB%AF+%26+%E7%94%A8%E6%88%B7%E8%84%9A%E6%9C%AC;Keep+building,+keep+breaking,+keep+fixing.&font=Fira+Code&center=true&width=620&pause=1200&color=7C3AED)](https://readme-typing-svg.demolab.com)

<!-- AUTO:START:badges -->

<img src="https://img.shields.io/badge/%E5%85%AC%E5%BC%80%E4%BB%93%E5%BA%93-9-blue?style=flat-square&logo=github" alt="公开仓库"> <img src="https://img.shields.io/badge/%E8%8E%B7%E5%BE%97%20Stars-33-yellow?style=flat-square&logo=githubsponsors" alt="获得 Stars"> <img src="https://img.shields.io/badge/Forks-0-orange?style=flat-square&logo=git" alt="Forks"> <img src="https://img.shields.io/badge/%E5%85%B3%E6%B3%A8%E8%80%85-4-7C3AED?style=flat-square&logo=github" alt="关注者"> <img src="https://img.shields.io/badge/%E5%85%A5%E9%A9%BB%E5%B9%B4%E4%BB%BD-2020-06B6D4?style=flat-square&logo=github" alt="入驻年份">
...
- 🔭 我正在维护 **[MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival)** —— 让老版 MegaDownloader 重新支持新版 MEGA 链接
...
![VRChat](https://img.shields.io/badge/VRChat-000000?style=flat-square)
...
| 仓库 | 说明 | 语言 | Stars |
|:---|:---|:---:|:---:|
| [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) | MegaDownloader 复活计划 (Revival Project) - 基于 v1.8 反… | Visual Basic .NET | ⭐ 30 |
...
- ⬆️ 向 [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) 推送了新代码 <sub>`6 天前`</sub>
- 🐛 关闭了 Issue [#2](https://github.com/a1175815821/MegaDownloader-Revival/issues/2) · [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) <sub>`8 天前`</sub>
- ⬆️ 向 [a1175815821](https://github.com/a1175815821/a1175815821) 推送了新代码 <sub>`9 天前`</sub>
- 🌱 在 [vrchat-friend-cleaner](https://github.com/a1175815821/vrchat-friend-cleaner) 创建了分支 <sub>`9 天前`</sub>
- 🚀 在 [vrchat-friend-cleaner](https://github.com/a1175815821/vrchat-friend-cleaner) 发布了 [v1.3.3 暗色全量/安全加固](https://github.com/a1175815821/vrchat-friend-cleaner/releases/tag/v1.3.3) <sub>`9 天前`</sub>
- 💬 在 [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) 的 [#2](https://github.com/a1175815821/MegaDownloader-Revival/issues/2) 中评论 <sub>`10 天前`</sub>
- 🚀 在 [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) 发布了 [v2.4.1](https://github.com/a1175815821/MegaDownloader-Revival/releases/tag/v2.4.1) <sub>`27 天前`</sub>
- ⬆️ 向 [DG-Lab-2.0-VRChat-OSC](https://github.com/a1175815821/DG-Lab-2.0-VRChat-OSC) 推送了新代码 <sub>`29 天前`</sub>
