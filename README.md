...
| 仓库 | 说明 | 语言 | Stars |
|:---|:---|:---:|:---:|
| [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) | MegaDownloader 复活计划 (Revival Project) - 基于 v1.8 反… | Visual Basic .NET | ⭐ 31 |
...
- 🔀 更新了 PR [#3](undefined) · [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) <sub>`8 分钟前`</sub>
- ⬆️ 向 [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) 推送了新代码 <sub>`17 分钟前`</sub>
- 🚀 在 [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) 发布了 [v2.5 RC1 (test)](https://github.com/a1175815821/MegaDownloader-Revival/releases/tag/test-v2.5-rc1) <sub>`17 小时前`</sub>
- 🌱 在 [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) 创建了分支 <sub>`17 小时前`</sub>
- 🐛 关闭了 Issue [#2](https://github.com/a1175815821/MegaDownloader-Revival/issues/2) · [MegaDownloader-Revival](https://github.com/a1175815821/MegaDownloader-Revival) <sub>`10 天前`</sub>
- ⬆️ 向 [a1175815821](https://github.com/a1175815821/a1175815821) 推送了新代码 <sub>`12 天前`</sub>
- 🌱 在 [vrchat-friend-cleaner](https://github.com/a1175815821/vrchat-friend-cleaner) 创建了分支 <sub>`12 天前`</sub>
- 🚀 在 [vrchat-friend-cleaner](https://github.com/a1175815821/vrchat-friend-cleaner) 发布了 [v1.3.3 暗色全量/安全加固](https://github.com/a1175815821/vrchat-friend-cleaner/releases/tag/v1.3.3) <sub>`12 天前`</sub>
